...
<body>
	...
	<form method="POST" name="movieForm" onsubmit="return validateForm()">
		<span class="warning" id="duplicate_movie_message"></span>
		<table style="width: auto;">
			<tr>
				<td>Movie Name: </td>
				<td><input type="text" name="movie_name" id="movie_name" onkeyup="ajaxCheck()"></td>
			</tr>
			<tr>
				<td>Release Year</td>
...
function ajaxCheck() {
  ...
  xhttp.onload = function() {
    document.getElementById("duplicate_movie_message").innerHTML =
    this.responseText;
  }
  xhttp.open("GET", "ajax_check.php?movie_name="+movie_name);
  xhttp.send();
}
</script>
</html>